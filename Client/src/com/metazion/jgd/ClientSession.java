...
public class ClientSession extends Session {
	...
	public void onActive() throws Exception {
		System.out.println(String.format("Client session active: [%s]", getChannelAddress(channel)));
	}

	@Override
	public void onInactive() throws Exception {
		System.out.println(String.format("Client session inactive: [%s]", getChannelAddress(channel)));
	}

	@Override
	public void onException() throws Exception {
		System.out.println(String.format("Client session exception: [%s]", getChannelAddress(channel)));
	}
